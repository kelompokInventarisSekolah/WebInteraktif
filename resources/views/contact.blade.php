    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{route('index')}}">StarbhakNEWS</a>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Contact</h1>
                            <span class="subheading">Ada Saran Atau Masukan?</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <!-- to get an API token!-->
                            <form  method="POST"  action="{{route('tambah_contact')}}" data-sb-form-api-token="API_TOKEN">
                                @include('sweetalert::alert')

                                @csrf
                                <div class="form-floating">
                                    <p>username : {{Auth::user()->name}}</p>
                                    <input class="form-control" id="name" name="id_user" type="hidden" placeholder="Enter your name..." value="{{Auth::user()->id}}" data-sb-validations="required" />
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="phone" type="tel" name= "no_hp" placeholder="Enter your phone number..." data-sb-validations="required" />
