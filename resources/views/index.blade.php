                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>StarbhakNEWS</h1>
                            <span class="subheading">Satu Topik Beragam Opini</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        ...
                        <a href="/detail/{{$item->id}}">
                            ...
                            <h3 class="post-subtitle">{{$item->deskripsi}}</h3>
                        </a>
                        <p class="post-meta">
                            Posted by
                            <a href="#!">StarbakNEWS</a>
                            on {{$item->created_at}}
                        </p>
                        @endforeach
                    </div>
                    ...
                    <!-- Post preview-->
                    <!-- Pager-->
                    <div class="d-flex justify-content-end mb-4">{{ $berita->links() }}</div>
                </div>
            </div>
        </div>
        <!-- Footer-->
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; Web Interaktif 2021</div>
                    </div>
                </div>
            </div>
        </footer>
