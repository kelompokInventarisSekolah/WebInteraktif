    ...
    <body>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Tentang Aplikasi Web Interaktif Bahasa Indonesia</p>
                        <p>Kelompok 1 </p>
                        <p>Anggota : <br> 1.Arya Yuda  2.Fikri Zharfan  3.Five Adil <br> 4.Erni Septa  5.M,Iqbal  6.M,Rivaldi <br> 7.Nurfauziah  8.Nurlaila
